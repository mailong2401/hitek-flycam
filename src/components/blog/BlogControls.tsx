    ...
    <>
      ...
      <div className="space-y-10 opacity-0 animate-showContent animation-delay-600">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1">
            <button
              ...
              className="w-full lg:w-auto bg-vibrant-red text-white font-medium tracking-wider py-3 px-8 hover:bg-red-600 transition-all duration-300 text-lg min-w-[200px] text-left rounded-3xl hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl group"
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-white/70/70 text-sm">
            {texts.switchPost}
          </span>
