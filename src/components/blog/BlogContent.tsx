    ...
    <>
      ...
      <div className="flex items-center justify-between gap-4 mb-10 opacity-0 animate-showContent">
        <div className="flex items-center gap-4">
          ...
          {/* Date */}
          <div className="text-white/80 text-xs md:text-sm hidden md:block">
            {formatDate()}
          </div>
        </div>
      ...
      <div className="topic text-white font-bold text-xl md:text-3xl lg:text-3xl mb-12 opacity-0 animate-showContent animation-delay-400">
        ...
        {currentPost.readTime && (
          <span className="text-white/70 text-sm md:text-base ml-3 font-normal">
      ...
      {currentPost.excerpt_vi || currentPost.excerpt_en ? (
        <div className="text-white/80 text-base md:text-lg mb-6 opacity-0 animate-showContent animation-delay-600 line-clamp-2">
          {displayLanguage === 'vi' 
            ? (currentPost.excerpt_vi || currentPost.excerpt_en)
      ...
      {/* Views count - nếu có */}
      {currentPost.views > 0 && (
        <div className="text-white/60 text-xs md:text-sm mb-2 opacity-0 animate-showContent animation-delay-800">
